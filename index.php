  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
          ...
          if (isset($_GET["id"])){
              $id = $_GET["id"];
              $sql = "SELECT id,title,author,time,category,headline,view,body FROM posts WHERE category =$id ORDER BY time DESC ";

          }else{
              $sql = "SELECT id,title,author,time,category,headline,view,body FROM posts ORDER BY time DESC ";
          }
          $result = $conn->query($sql);
          ...
          <div class="card-body">
            ...
            <a href="details.php?id='.$id.'" class="btn btn-primary">Read More &rarr;</a>
          </div>' .' <div class="card-footer text-muted">Posted On '. $time .'<a href="#"> Author: '.$author.'</a> </div>
        </div>' ;
